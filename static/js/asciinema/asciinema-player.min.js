var AsciinemaPlayer = (function (A) {
  ...
  class B {
    ...
    log(A) {
      for (
        var g = arguments.length, I = new Array(g > 1 ? g - 1 : 0), B = 1;
        B < g;
        B++
      )
        I[B - 1] = arguments[B];
  ...
  function o() {
    return (
      (null !== t && 0 !== t.byteLength) ||
        (t = new Uint8Array(Q.memory.buffer)),
      t
    );
  }
  function s(A, g) {
    return ((A >>>= 0), i.decode(o().subarray(A, A + g)));
  }
  function n(A) {
    V === C.length && C.push(C.length + 1);
    const g = V;
    return ((V = C[g]), (C[g] = A), g);
  }
  function r(A) {
    const g = typeof A;
  ...
  function w(A, g, I) {
    ...
    if (E !== B) {
      (0 !== E && (A = A.slice(E)),
        (Q = I(Q, B, (B = E + 3 * A.length), 1) >>> 0));
      const g = o().subarray(Q + E, Q + B);
      ((E += D(A, g).written), (Q = I(Q, B, E, 1) >>> 0));
    }
    return ((a = E), Q);
  }
  let h = null;
  function l() {
    return (
      (null !== h && 0 !== h.byteLength) ||
        (h = new Int32Array(Q.memory.buffer)),
      h
    );
  }
  let y = null;
  function k(A, g) {
    return (
      ...
      ((null !== y && 0 !== y.byteLength) ||
        (y = new Uint32Array(Q.memory.buffer)),
      y).subarray(A / 4, A / 4 + g)
    );
  }
  const G =
    "undefined" == typeof FinalizationRegistry
      ? { register: () => {}, unregister: () => {} }
      : new FinalizationRegistry((A) => Q.__wbg_vt_free(A >>> 0));
  class F {
    static __wrap(A) {
      A >>>= 0;
      const g = Object.create(F.prototype);
      return ((g.__wbg_ptr = A), G.register(g, g.__wbg_ptr, g), g);
    }
    __destroy_into_raw() {
      const A = this.__wbg_ptr;
      return ((this.__wbg_ptr = 0), G.unregister(this), A);
    }
    free() {
    ...
    feed(A) {
      const g = w(A, Q.__wbindgen_malloc, Q.__wbindgen_realloc),
        I = a;
      return e(Q.vt_feed(this.__wbg_ptr, g, I));
    }
    resize(A, g) {
      return e(Q.vt_resize(this.__wbg_ptr, A, g));
    }
    inspect() {
      let A, g;
      try {
        const C = Q.__wbindgen_add_to_stack_pointer(-16);
        Q.vt_inspect(C, this.__wbg_ptr);
        var I = l()[C / 4 + 0],
          B = l()[C / 4 + 1];
        return ((A = I), (g = B), s(I, B));
      } finally {
        (Q.__wbindgen_add_to_stack_pointer(16), Q.__wbindgen_free(A, g, 1));
      }
    }
    getSize() {
      try {
        const B = Q.__wbindgen_add_to_stack_pointer(-16);
        Q.vt_getSize(B, this.__wbg_ptr);
        var A = l()[B / 4 + 0],
          g = l()[B / 4 + 1],
          I = k(A, g).slice();
        return (Q.__wbindgen_free(A, 4 * g, 4), I);
      } finally {
        Q.__wbindgen_add_to_stack_pointer(16);
      }
    }
    getLine(A) {
      return e(Q.vt_getLine(this.__wbg_ptr, A));
    }
    getCursor() {
      return e(Q.vt_getCursor(this.__wbg_ptr));
    }
  }
  function q() {
    const A = { wbg: {} };
    return (
      ...
      (A.wbg.__wbg_set_388c4c6422704173 = function (A, g, I) {
        return n(E(A).set(E(g), E(I)));
      }),
      (A.wbg.__wbindgen_debug_string = function (A, g) {
        const I = w(r(E(g)), Q.__wbindgen_malloc, Q.__wbindgen_realloc),
          B = a;
        ((l()[A / 4 + 1] = B), (l()[A / 4 + 0] = I));
      }),
  ...
  var N = Object.freeze({
    __proto__: null,
    Vt: F,
    create: function (A, g, I) {
      const B = Q.create(A, g, I);
      return F.__wrap(B);
    },
    default: M,
    initSync: function (A) {
      ...
      return (
        ...
        d(new WebAssembly.Instance(A, g), A)
      );
    },
  });
  const f = [
  ...
  const R = (function (A) {
    ...
    for (let I = 0, C = 0; I < B; I += 4, C += 3)
      ((g =
        (u(A.charCodeAt(I)) << 18) |
        (u(A.charCodeAt(I + 1)) << 12) |
        (u(A.charCodeAt(I + 2)) << 6) |
        u(A.charCodeAt(I + 3))),
        (Q[C] = g >> 16),
        (Q[C + 1] = (g >> 8) & 255),
        (Q[C + 2] = 255 & g));
  ...
  class Y {
    ...
    transform(A) {
      return new Y(this.input, this.xfs.concat([A]));
    }
    multiplex(A, g) {
      return new Y(new p(this[Symbol.iterator](), A[Symbol.iterator](), g));
    }
    toArray() {
  ...
  async function L(A) {
    ...
    if (1 === g.version)
      return (function (A) {
        let g = 0;
        const I = new Y(A.stdout).map((A) => ((g += A[0]), [g, "o", A[1]]));
  ...
  function m(A) {
    ...
    if (
      g.test(I) &&
      g.test(B) &&
      /^(#[0-9A-Fa-f]{6}:){7,}#[0-9A-Fa-f]{6}$/.test(Q)
    )
      return { foreground: I, background: B, palette: Q.split(":") };
  }
  function K(A) {
  ...
  function b() {
    ...
    return function (g) {
      return "m" === g[1]
        ? [g[0], g[1], { index: A++, time: g[0], label: g[2] }]
        : g;
    };
  }
  class H {
  ...
  function v(A, g, I, B, Q, C, E) {
    const V = (function (A, g) {
      return function (I, B) {
        "o" === I ? A(B) : "r" === I && g(B.cols, B.rows);
      };
    })(g, I);
    if (0 === A)
      return (
        E.debug("using no buffer"),
        (function (A) {
          return {
            pushEvent(g) {
              A(g[1], g[2]);
      ...
      );
    {
      ...
      return (
        "number" == typeof (A = A ?? {})
          ? (E.debug(`using fixed time buffer (${A} ms)`), (g = (g) => A))
          : "function" == typeof A
            ? (E.debug("using custom dynamic buffer"), (g = A({ logger: E })))
            : (E.debug("using adaptive buffer", A),
              (g = (function (A, g) {
                let { logger: I } = A,
                  {
                    minTime: B = 25,
                    ...
                    interval: C = 50,
                    windowSize: E = 20,
                    smoothingFactor: V = 0.2,
                    minImprovementDuration: e = 1e3,
                  } = g,
                  i = 0,
                  t = a(i),
                  o = [],
                ...
                return (A) => {
                  if ((o.push(A), o.length < E)) return t;
                  o = o.slice(-E);
                  const g = o.reduce((A, g) => (g < A ? g : A));
                  const B = (function (A) {
                    return A.reduce((A, g) => (g > A ? g : A));
                  })(o);
                  ((s = B * V + s * (1 - V)), (n = (B - g) * V + n * (1 - V)));
                  const C = s + n;
                  if (
                    (A > t &&
                      I.debug("buffer underrun", {
                        latency: A,
                        maxJitter: s,
                        jitterRange: n,
                        bufferTime: t,
                    ...
                    ((t = a((i += 1))),
                      I.debug("jitter increased, raising bufferTime", {
                        latency: A,
                        maxJitter: s,
                        jitterRange: n,
                        bufferTime: t,
                      }));
                  else if ((i > 1 && C < a(i - 2)) || (1 == i && C < a(i - 1)))
                    return (
                      null === r
                        ? (r = performance.now())
                        : performance.now() - r > e &&
                          ((r = performance.now()),
                          (t = a((i -= 1))),
                          I.debug("jitter decreased, lowering bufferTime", {
                            latency: A,
                            maxJitter: s,
                            jitterRange: n,
                            bufferTime: t,
          ...
          return (
            ...
            }, 0),
            {
              pushEvent(g) {
                let I = o() - 1e3 * g[0];
                (I < 0 &&
                  (B.debug(`correcting epoch by ${I} ms`), (E += I), (I = 0)),
                  (V = A(I)),
                  e.push(g));
              },
              pushText(A) {
  ...
  function x(A) {
    ...
    let B,
      Q = function (A) {
        ...
        if ("ALiS" !== g) throw "not an ALiS v1 live stream";
        Q = C;
      };
    function C(I) {
      const C = new X(new DataView(I)),
        V = C.getUint8();
      if (1 !== V) throw `expected init (0x01) frame, got ${V}`;
      let e = C.decodeVarUint();
      ((B = e), (e /= O));
      const i = C.decodeVarUint(),
        t = C.decodeVarUint(),
        o = C.getUint8();
      let s;
      if (8 === o) {
        const A = 30;
        ((s = j(new Uint8Array(I, C.offset, A))), C.forward(A));
      } else if (16 === o) {
        const A = 54;
        ((s = j(new Uint8Array(I, C.offset, A))), C.forward(A));
      } else if (0 !== o)
        return (
          A.warn(`alis: unsupported theme format (${o})`),
          void socket.close()
        );
      const n = C.decodeVarUint();
      let r;
      return (
        n > 0 && (r = g.decode(new Uint8Array(I, C.offset, n))),
        (Q = E),
        { time: e, term: { size: { cols: i, rows: t }, theme: s, init: r } }
      );
    }
    function E(E) {
      const V = new X(new DataView(E)),
        e = V.getUint8();
      if (111 === e) {
        const A = V.decodeVarUint();
        B += A;
        const I = V.decodeVarUint(),
          Q = g.decode(new Uint8Array(E, V.offset, I));
        return [B / O, "o", Q];
      }
      if (105 === e) {
        const A = V.decodeVarUint();
        B += A;
        const g = V.decodeVarUint(),
          Q = I.decode(new Uint8Array(E, V.offset, g));
        return [B / O, "i", Q];
      }
      if (114 === e) {
        const A = V.decodeVarUint();
        ...
        const g = V.decodeVarUint(),
          I = V.decodeVarUint();
        return [B / O, "r", { cols: g, rows: I }];
      }
      if (109 === e) {
        const A = V.decodeVarUint();
        B += A;
        const g = V.decodeVarUint(),
          I = new TextDecoder().decode(new Uint8Array(E, V.offset, g));
        return [B / O, "m", I];
      }
      if (4 === e) return ((Q = C), !1);
      A.debug(`alis: unknown frame type: ${e}`);
    }
    return function (A) {
      return Q(A);
    };
  ...
  function j(A) {
    const g = A.length / 3,
      ...
      B = Z(A[3], A[4], A[5]),
      Q = [];
    for (let I = 2; I < g; I++) Q.push(Z(A[3 * I], A[3 * I + 1], A[3 * I + 2]));
    return { foreground: I, background: B, palette: Q };
  }
  function Z(A, g, I) {
    return `#${W(A)}${W(g)}${W(I)}`;
  }
  ...
  class X {
    ...
    decodeVarUint() {
      let A = 0,
        ...
        I = this.getUint8();
      for (; I > 127; )
        ((I &= 127), (A += I << g), (g += 7), (I = this.getUint8()));
      return A + (I << g);
    }
  }
  function z() {
    ...
    let g = function (B) {
      ...
      return (
        (g = I),
        { time: 0, term: { size: { cols: C, rows: E }, init: Q } }
      );
    };
    function I(g) {
      return A.decode(g, { stream: !0 });
    }
    return function (A) {
      return g(A);
    };
  ...
  class BA extends gA {
    onEnter(A) {
      let { reason: g, message: I } = A;
      (this.core._dispatchEvent("idle", { message: I }),
        "paused" === g && this.core._dispatchEvent("pause"));
    }
    async play() {
  ...
  class EA extends gA {
    onEnter(A) {
      let { message: g } = A;
      this.core._dispatchEvent("offline", { message: g });
    }
  }
  class VA extends gA {
    onEnter(A) {
      let { message: g } = A;
      this.core._dispatchEvent("ended", { message: g });
    }
    async play() {
      (this.core._dispatchEvent("play"),
    ...
    seek(A) {
      return !0 === this.driver.seek(A) && (this.core._setState("idle"), !0);
    }
  }
  class eA extends gA {
    onEnter() {
  ...
  class iA {
    constructor(A, I) {
      ((this.src = A),
        ...
        (this.startAt = g(I.startAt)),
        (this.poster = this._parsePoster(I.poster)),
        (this.markers = this._normalizeMarkers(I.markers)),
        (this.pauseOnMarkers = I.pauseOnMarkers),
    ...
    async init() {
      ...
      const A = this._feed.bind(this),
        g = this._now.bind(this),
        I = this._resetVt.bind(this),
        B = this._resizeVt.bind(this),
        Q = this._setState.bind(this),
        C = "npt" === this.poster.type ? this.poster.value : void 0;
      ((this.driver = (function (A) {
        ...
        if (
          ...
          if (!oA.has(A.parser)) throw `unknown parser: ${A.parser}`;
          A.parser = oA.get(A.parser);
        }
        if (tA.has(A.driver)) {
          const g = tA.get(A.driver);
          return (I, B) => g(A, I, B);
        }
      ...
      })(this.src)(
        {
          ...
          onMarker: (A) => {
            ...
            this._dispatchEvent("marker", { index: g, time: I, label: B });
          },
          reset: I,
          resize: B,
          now: g,
          setTimeout: (A, g) => setTimeout(A, g / this.speed),
          setInterval: (A, g) => setInterval(A, g / this.speed),
          setState: Q,
          logger: this.logger,
        },
        {
        ...
        (this.preload || void 0 !== C) && this._withState((A) => A.init()));
      const E =
      ...
      if (
        ...
        void 0 === this.driver.step && (this.driver.step = (A) => {}),
        ...
        let g = new S();
        ((this.driver.play = () => ((g = new J(this.speed)), A())),
    ...
    seek(A) {
      return this._withState(async (g) => {
        (await g.seek(A)) && this._dispatchEvent("seeked");
      });
    }
    step(A) {
      return this._withState((g) => g.step(A));
    }
    stop() {
    ...
    getChanges() {
      ...
      if (this.changedLines.size > 0) {
        ...
        for (const A of this.changedLines)
          A < I && g.set(A, { id: A, segments: this.vt.getLine(A) });
        (this.changedLines.clear(), (A.lines = g));
      }
      return (
        void 0 === this.cursor &&
          this.vt &&
    ...
    _enqueueCommand(A) {
      return (
        (this.commandQueue = this.commandQueue.then(A)),
        this.commandQueue
      );
    }
    _setState(A) {
      ...
      if (((this.stateName = A), "playing" === A)) this.state = new QA(this);
      else if ("idle" === A) this.state = new BA(this);
      else if ("loading" === A) this.state = new CA(this);
      else if ("ended" === A) this.state = new VA(this);
      else if ("offline" === A) this.state = new EA(this);
      else {
        if ("errored" !== A) throw `invalid state: ${A}`;
        this.state = new eA(this);
      }
    ...
    async _initializeDriver() {
      ...
      const g = void 0 !== A.poster ? this._renderPoster(A.poster) : void 0;
    ...
    _resetVt(A, g) {
      ...
      ((this.cols = A),
        (this.rows = g),
        (this.cursor = void 0),
        this._initializeVt(A, g),
        void 0 !== I && "" !== I && this._doFeed(I),
        this._dispatchEvent("reset", { cols: A, rows: g, theme: B }));
    }
    _resizeVt(A, g) {
      if (A === this.vt.cols && g === this.vt.rows) return;
      (this.vt.resize(A, g).forEach((A) => this.changedLines.add(A)),
        (this.cursor = void 0),
        (this.vt.cols = A),
        (this.vt.rows = g),
        this.logger.debug(`core: vt resize (${A}x${g})`),
        this._dispatchEvent("resize", { cols: A, rows: g }));
    }
    _initializeVt(A, g) {
    ...
    _parsePoster(A) {
      return "string" != typeof A
        ...
        : "data:text/plain," == A.substring(0, 16)
          ...
          : "npt:" == A.substring(0, 4)
            ? { type: "npt", value: g(A.substring(4)) }
            : {};
    }
    _renderPoster(A) {
      ...
      const Q = B.getCursor() ?? !1,
        C = [];
      for (let A = 0; A < I; A++) C.push({ id: A, segments: B.getLine(A) });
  ...
  const tA = new Map([
      [
        ...
        function (A, g) {
          let I,
            ...
            { feed: C, setState: E, now: V } = g,
            e = 0;
          return {
            async init() {
              const A = await L(await fetch(B)),
      ...
      [
        ...
        function (A, g, I) {
          ...
          return {
            init: () => {
              const A = [o].concat(n());
              return { cols: V, rows: e, duration: 1440, poster: A };
            },
            play: () => (E(o), r(), (s = setInterval(r, 1e3)), !0),
            stop: () => {
              clearInterval(s);
            },
            getCurrentTime: () => {
      ...
      [
        ...
        function (A, g) {
          let I,
            Q,
            { url: C, bufferTime: E, minFrameTime: V } = A,
            { feed: e, reset: i, setState: t, logger: o } = g;
          o = new B(o, "eventsource: ");
          let s = new S();
          function n(A) {
            (void 0 !== Q && Q.stop(),
              (Q = v(E, e, (A) => s.setTime(A), A, V, o)));
          }
          return {
            play: () => {
              ((I = new EventSource(C)),
                ...
                I.addEventListener("message", (A) => {
                  ...
                  if (Array.isArray(g)) Q.pushEvent(g);
                    ...
                    "offline" === g.state &&
                      (o.info("stream offline"),
                      t("offline", { message: "Stream offline" }),
                      (s = new S()));
                }),
                I.addEventListener("done", () => {
                  (o.info("closed"),
                    I.close(),
                    t("ended", { message: "Stream ended" }));
                }));
            },
            stop: () => {
              (void 0 !== Q && Q.stop(), void 0 !== I && I.close());
            },
      ...
      [
        ...
        function (A, g, I) {
          ...
          async function R(A, g) {
            ...
            if (!I.ok)
              throw `failed fetching recording from ${A}: ${I.status} ${I.statusText}`;
            return I;
          }
          function J() {
            const A = C[N];
          ...
          function p(A) {
            ...
            if ("o" === I) s(B);
              ...
              return (m(), (o = 1e3 * g), w("idle", { reason: "paused" }), !0);
            return !1;
          }
          function L() {
            (U(),
              u++,
              !0 === k || ("number" == typeof k && u < k)
                ? ((N = 0), (t = c()), s("c"), O(), J())
                : ((o = 1e3 * V), w("ended")));
          }
          function m() {
          ...
          function v(A) {
                ...
                : ">>" === A
                  ...
                  : "<<<" === A
                    ...
                    : ">>>" === A
                      ...
                      : "%" === A[A.length - 1] &&
                        (A =
                          (parseFloat(A.substring(0, A.length - 1)) / 100) * V);
            else if ("object" == typeof A)
              if ("prev" === A.marker)
                ((A = T(I) ?? 0), g && I - A < 1 && (A = T(A) ?? 0));
            ...
            const B = Math.min(Math.max(A, 0), V);
            B < f && (s("c"), O(), (N = 0), (f = 0));
            let Q = C[N];
            for (; Q && Q[0] <= B; )
              ("o" === Q[1] && p(Q), (f = Q[0]), (Q = C[++N]));
            return ((o = 1e3 * B), (e = null), g && H(), !0);
          }
          function T(A) {
            if (0 == E.length) return;
            let g,
          ...
          return {
            init: async function () {
                ...
                s = (function (A, g, I) {
                  ...
                  ((e = e
                    ...
                    void 0 !== V &&
                      ...
                      (e = e
                        .filter((A) => "m" !== A[1])
                        .multiplex(V, (A, g) => A[0] < g[0])
                        .map(b()))));
                  ((e = e.toArray()),
                    void 0 !== E &&
                      ((e = e.map((A) =>
                        "i" === A[1] ? [A[0] + E, A[1], A[2]] : A,
                      )),
                      e.sort((A, g) => A[0] - g[0])));
                  const t = e[e.length - 1][0],
                    o = B - i.offset;
                  return { ...A, events: e, duration: t, effectiveStartAt: o };
                })(
                  await g(
                    await (function (A) {
                      ...
                      if (Array.isArray(g))
                        return Promise.all(g.map((A) => R(A, B)));
                      if (void 0 !== I)
                        return (
                          "function" == typeof I && (I = I()),
                          I instanceof Promise || (I = Promise.resolve(I)),
                          I.then((A) =>
                            "string" == typeof A || A instanceof ArrayBuffer
                              ? new Response(A)
                              : A,
                          )
                        );
              ...
              void 0 !== t &&
                (function (A, g) {
                  ...
                  ((I.href = URL.createObjectURL(
                    new Blob([Q], { type: "text/plain" }),
                  )),
                    (I.download = g),
                    I.click());
                })(s, t);
              const n =
                void 0 !== G
                  ? ((r = G),
                    C.filter((A) => A[0] < r && "o" === A[1]).map((A) => A[2]))
                  : void 0;
              var r;
              return (
                (E = C.filter((A) => "m" === A[1]).map((A) => [
                  A[0],
                  A[2].label,
                ])),
                {
            ...
            play: function () {
              if (i) throw "already playing";
              if (void 0 === C[N]) throw "already ended";
              return (null !== e && v(e), H(), !0);
            },
            pause: m,
            seek: v,
            step: function (A) {
              ...
              if ((void 0 === A && (A = 1), A > 0)) {
                ...
                g = C[B];
                for (let Q = 0; Q < A; Q++) {
                  for (; void 0 !== g && "o" !== g[1]; ) g = C[++B];
                  void 0 !== g && "o" === g[1] && (I = B);
                }
              } else {
                let B = Math.max(N - 2, 0);
                g = C[B];
                for (let Q = A; Q < 0; Q++) {
                  for (; void 0 !== g && "o" !== g[1]; ) g = C[--B];
                  void 0 !== g && "o" === g[1] && (I = B);
            ...
            restart: function () {
              if (i) throw "still playing";
              if (void 0 !== C[N]) throw "not ended";
              return (v(0), H(), !0);
            },
            stop: m,
            getCurrentTime: function () {
              return i ? (c() - t) / 1e3 : (o ?? 0) / 1e3;
            },
          };
        },
      ],
      [
        ...
        function (A, g) {
          let I,
            ...
            { feed: i, reset: t, resize: o, setState: s, logger: n } = g;
          n = new B(n, "websocket: ");
          let r,
            a,
            c = new S(),
            ...
            h = !1;
          function l() {
            ((I = new WebSocket(C, ["v1.alis", "v2.asciicast", "raw"])),
              (I.binaryType = "arraybuffer"),
              (I.onopen = () => {
                const A = I.protocol || "raw";
                (n.info("opened"),
                  n.info(`activating ${A} protocol handler`),
                  "v1.alis" === A
                    ? (I.onmessage = y(x(n)))
                    : "v2.asciicast" === A
                      ? (I.onmessage = y(
                          (function () {
                            let A = function (I) {
                              ...
                              return (
                                (A = g),
                                {
                                  time: 0,
                                  term: {
                                    size: { cols: B.width, rows: B.height },
                                  },
                                }
                              );
                            };
                            function g(A) {
                              ...
                              if ("r" === g[1]) {
                                const [A, I] = g[2].split("x");
                                return [g[0], "r", { cols: A, rows: I }];
                              }
                              return g;
                            }
                            return function (g) {
              ...
              (I.onclose = (A) => {
                if (
                  (clearTimeout(a), G(), w || 1e3 === A.code || 1005 === A.code)
                )
                  (n.info("closed"), s("ended", { message: "Stream ended" }));
                else if (1002 === A.code)
                  (n.debug(`close reason: ${A.reason}`),
                    s("ended", {
                  ...
                  clearTimeout(r);
                  const A = V(D++);
                  (n.info(`unclean close, reconnecting in ${A}...`),
                    s("loading"),
                    setTimeout(l, A));
                }
              }),
          ...
          function y(A) {
            return (
              ...
              function (g) {
                const I = A(g.data);
                if (Q) {
                  if (Array.isArray(I)) Q.pushEvent(I);
                  else if ("string" == typeof I) Q.pushText(I);
                  else if (!1 === I) k();
                  else if (void 0 !== I)
                    throw `unexpected value from protocol handler: ${I}`;
                } else if ("object" != typeof I || Array.isArray(I)) {
                  if (void 0 !== I)
                    throw (
                      clearTimeout(a),
                      `unexpected value from protocol handler: ${I}`
                    );
                  (clearTimeout(a), (a = setTimeout(k, 1e3)));
                } else {
                  const { time: A, term: g } = I,
                    { size: B, init: C, theme: V } = g,
                    { cols: r, rows: D } = B;
                  (!(function (A, g, I, B, C) {
                    (n.info(`stream init (${A}x${g} @${I})`),
                      s("playing"),
                      G(),
                      (Q = v(E, i, o, (A) => c.setTime(A), I, e, n)),
                      t(A, g, B, C),
                      (c = new J()),
                      (h = !0),
                      "number" == typeof I && c.setTime(I));
                  })(r, D, A, C, V),
                    clearTimeout(a));
                }
              }
          ...
          function k() {
            (G(),
              h
                ? (n.info("stream ended"),
                  s("offline", { message: "Stream ended" }))
                : (n.info("stream offline"),
                  s("offline", { message: "Stream offline" })),
              (c = new S()));
          }
          function G() {
            (Q && Q.stop(), (Q = null));
    ...
    oA = new Map([
      ...
      [
        ...
        async function (A, g) {
          ...
          const V = await A[1].arrayBuffer(),
            e = new Uint8Array(V),
            i = e.findIndex((A) => 10 == A) + 1,
            t = B.decode(e.subarray(0, i)).match(
              /COLUMNS="(\d+)" LINES="(\d+)"/,
            );
          null !== t && ((Q = parseInt(t[1], 10)), (C = parseInt(t[2], 10)));
          const o = { array: e, cursor: i };
          let s = o;
          if (void 0 !== A[2]) {
            const g = await A[2].arrayBuffer();
            s = { array: new Uint8Array(g), cursor: i };
          }
          const n = [];
          let r = 0;
          for (const A of E)
            if (((r += parseFloat(A[1])), "O" === A[0])) {
              const g = parseInt(A[2], 10),
                I = o.array.subarray(o.cursor, o.cursor + g),
                Q = B.decode(I);
              (n.push([r, "o", Q]), (o.cursor += g));
            } else if ("I" === A[0]) {
              const g = parseInt(A[2], 10),
                I = s.array.subarray(s.cursor, s.cursor + g),
                Q = B.decode(I);
              (n.push([r, "i", Q]), (s.cursor += g));
      ...
      [
        ...
        async function (A, g) {
          ...
          const B = new TextDecoder(I),
            ...
            E = _(C),
            V = E.time,
            e = B.decode(E.data).match(/\x1b\[8;(\d+);(\d+)t/),
            i = [];
          let t = 80,
            o = 24;
          null !== e && ((t = parseInt(e[2], 10)), (o = parseInt(e[1], 10)));
          let s = 0,
            n = _(C);
          for (; void 0 !== n; ) {
            const A = n.time - V,
              g = B.decode(n.data);
            (i.push([A, "o", g]), (s += n.len), (n = _(C.subarray(s))));
          }
          return { cols: t, rows: o, events: i };
        },
      ],
    ]);
  const sA = {};
  const nA = Symbol("solid-proxy"),
    rA = Symbol("solid-track"),
    aA = { equals: (A, g) => A === g };
  let cA = vA;
  const DA = 1,
    wA = 2,
    hA = { owned: null, cleanups: null, context: null, owner: null };
  var lA = null;
  let yA = null,
    kA = null,
    GA = null,
  ...
  function MA(A, g) {
    const I = {
      ...
      observers: null,
      observerSlots: null,
      comparator: (g = g ? Object.assign({}, aA, g) : aA).equals || void 0,
    };
    return [
      pA.bind(I),
      (A) => ("function" == typeof A && (A = A(I.value)), LA(I, A)),
    ];
  }
  function NA(A, g, I) {
    mA(KA(A, g, !1, DA));
  ...
  function JA(A) {
    !(function (A, g, I) {
      cA = TA;
      const B = KA(A, g, !1, DA);
      ((B.user = !0), FA ? FA.push(B) : mA(B));
    })(() => RA(A));
  }
  function SA(A) {
    return (
      null === lA ||
        (null === lA.cleanups ? (lA.cleanups = [A]) : lA.cleanups.push(A)),
      A
    );
  }
  function YA() {
  ...
  function pA() {
    ...
    if (this.sources && (this.state || A))
      if (this.state === DA || A) mA(this);
      else {
        const A = GA;
        ((GA = null), HA(() => OA(this), !1), (GA = A));
      }
    if (kA) {
      const A = this.observers ? this.observers.length : 0;
      (kA.sources
        ? (kA.sources.push(this), kA.sourceSlots.push(A))
        : ((kA.sources = [this]), (kA.sourceSlots = [A])),
        this.observers
          ? (this.observers.push(kA),
            this.observerSlots.push(kA.sources.length - 1))
          : ((this.observers = [kA]),
            (this.observerSlots = [kA.sources.length - 1])));
    }
    return this.value;
  }
  function LA(A, g, I) {
            ...
            for (let g = 0; g < A.observers.length; g += 1) {
              ...
              (B && yA.disposed.has(I),
                ((B && !I.tState) || (!B && !I.state)) &&
                  (I.pure ? GA.push(I) : FA.push(I), I.observers && xA(I)),
                B || (I.state = DA));
            }
            if (GA.length > 1e6) throw ((GA = []), new Error());
          }, !1)),
      g
    );
  }
    ...
    ((kA = lA = A),
      (function (A, g, I) {
        ...
        try {
          ...
          (A.pure &&
            ((A.state = DA), A.owned && A.owned.forEach(jA), (A.owned = null)),
            ZA(g));
        }
        (!A.updatedAt || A.updatedAt <= I) &&
          (null != A.updatedAt && "observers" in A ? LA(A, B) : (A.value = B),
          (A.updatedAt = I));
      })(A, A.value, B),
      (kA = I),
      (lA = g));
  }
  function KA(A, g, I, B = DA, Q) {
    const C = {
      fn: A,
      state: B,
      updatedAt: null,
    ...
    return (
      null === lA ||
        (lA !== hA && (lA.owned ? lA.owned.push(C) : (lA.owned = [C]))),
      C
    );
  }
  function bA(A) {
    ...
    if (A.state === wA || g) return OA(A);
    if (A.suspense && RA(A.suspense.inFallback))
      return A.suspense.effects.push(A);
    const I = [A];
    for (; (A = A.owner) && (!A.updatedAt || A.updatedAt < qA); )
      (A.state || g) && I.push(A);
    for (let B = I.length - 1; B >= 0; B--)
      if ((A = I[B]).state === DA || g) mA(A);
      else if (A.state === wA || g) {
        const g = GA;
        ((GA = null), HA(() => OA(A, I[0]), !1), (GA = g));
      }
  }
  function HA(A, g) {
    if (GA) return A();
    ...
    try {
      ...
      return (
        (function (A) {
          ...
          if (A) return;
          const g = FA;
          ((FA = null), g.length && HA(() => cA(g), !1));
        })(I),
        g
      );
    } catch (A) {
      (I || (FA = null), (GA = null), ZA(A));
    }
  }
  function vA(A) {
    for (let g = 0; g < A.length; g++) bA(A[g]);
  }
  function TA(A) {
    let g,
      I = 0;
    ...
    var B;
    for (sA.context && (sA.context = B), g = 0; g < I; g++) bA(A[g]);
  }
  function OA(A, g) {
    const I = yA;
    A.state = 0;
  ...
  function jA(A) {
    ...
    if (A.owned) {
      for (g = 0; g < A.owned.length; g++) jA(A.owned[g]);
      A.owned = null;
    }
    if (A.cleanups) {
  ...
  function ZA(A) {
    throw (A = (function (A) {
      return A instanceof Error || "string" == typeof A
        ? A
        : new Error("Unknown error");
    })(A));
  }
  function WA(A) {
    if ("function" == typeof A && !A.length) return WA(A());
    if (Array.isArray(A)) {
      const g = [];
  ...
  const $A = {
    get: (A, g, I) => (g === nA ? I : A.get(g)),
    has: (A, g) => g === nA || A.has(g),
    set: _A,
    deleteProperty: _A,
              ...
              RA(() => {
                ...
                if (0 === h)
                  ...
                  for (
                    ...
                    ((s[D] = Q[c]), (n[D] = C[c]), V && (r[D] = V[c]));
                  for (A = new Map(), g = new Array(D + 1), i = D; i >= a; i--)
                    ((w = t[i]),
                      (e = A.get(w)),
                      (g[i] = void 0 === e ? -1 : e),
                      A.set(w, i));
  ...
  function Qg(A) {
    ...
    return fA(
      () => {
        ...
        const V = E.children,
          e = "function" == typeof V && V.length > 0;
        return ((g = I || e), e ? RA(() => V(C)) : V);
      },
      void 0,
      void 0,
    );
  ...
  function Vg(A, g, I, B = {}) {
    ...
    return (
      dA((B) => {
        ((Q = B),
          g === document ? A() : rg(g, A(), g.firstChild ? null : void 0, I));
      }, B.owner),
      () => {
        (Q(), (g.textContent = ""));
      }
  ...
  function ig(A, g = window.document) {
    const I = g[Eg] || (g[Eg] = new Set());
    for (let B = 0, Q = A.length; B < Q; B++) {
      const Q = A[B];
      I.has(Q) || (I.add(Q), g.addEventListener(Q, ag));
    }
  }
  function tg(A, g) {
  ...
  function sg(A, g, I) {
    ...
    let Q, C;
    for (C in ("string" == typeof I && (B.cssText = I = void 0),
    I || (I = {}),
    g || (g = {}),
    I))
  ...
  function ag(A) {
    ...
    for (
      ...
      if (B && !I.disabled) {
        const Q = I[`${g}Data`];
        if ((void 0 !== Q ? B.call(I, Q, A) : B.call(I, A), A.cancelBubble))
          return;
      }
  ...
  function cg(A, g, I, B, Q) {
    for (sA.context && !I && (I = [...A.childNodes]); "function" == typeof I; )
      I = I();
    if (g === I) return I;
    const C = typeof g,
      E = void 0 !== B;
    if (
      ...
      if (Array.isArray(g)) {
        const C = [],
          V = I && Array.isArray(I);
        if (Dg(C, g, I, Q))
          return (NA(() => (I = cg(A, C, I, B, !0))), () => I);
        if (sA.context) {
          if (!C.length) return I;
          for (let A = 0; A < C.length; A++)
            if (C[A].parentNode) return (I = C);
        }
        if (0 === C.length) {
          if (((I = hg(A, I, B)), E)) return I;
        } else
          V
            ? 0 === I.length
              ? wg(A, C, B)
              : (function (A, g, I) {
                  ...
                  for (; E < Q || V < C; )
                    if (g[E] !== I[V]) {
                      ...
                      if (Q === E) {
                        const g =
                          C < B ? (V ? I[V - 1].nextSibling : I[C - V]) : e;
                        for (; V < C; ) A.insertBefore(I[V++], g);
                      } else if (C === V)
                        for (; E < Q; )
                          ((i && i.has(g[E])) || g[E].remove(), E++);
                      else if (g[E] === I[C - 1] && I[V] === g[Q - 1]) {
                        const B = g[--Q].nextSibling;
                        (A.insertBefore(I[V++], g[E++].nextSibling),
                        ...
                        if (null != B)
                          if (V < B && B < C) {
                            ...
                            if (o > B - V) {
                              const Q = g[E];
                              for (; V < B; ) A.insertBefore(I[V++], Q);
                            } else A.replaceChild(I[V++], g[E++]);
                          } else E++;
                        else g[E++].remove();
                      }
                    } else (E++, V++);
        ...
        if (sA.context && g.parentNode) return (I = E ? [g] : g);
        if (Array.isArray(I)) {
          if (E) return (I = hg(A, I, B, g));
          hg(A, I, null, g);
        } else
  ...
  function Dg(A, g, I, B) {
    ...
    for (let C = 0, E = g.length; C < E; C++) {
      ...
      else if (Array.isArray(E)) Q = Dg(A, E, V) || Q;
      else if ("function" == typeof E)
        if (B) {
          for (; "function" == typeof E; ) E = E();
          Q =
            Dg(A, Array.isArray(E) ? E : [E], Array.isArray(V) ? V : [V]) || Q;
        } else (A.push(E), (Q = !0));
      else {
        const g = String(E);
        V && 3 === V.nodeType && V.data === g
          ? A.push(V)
  ...
  const lg = Symbol("store-raw"),
    yg = Symbol("store-node"),
    kg = Symbol("store-name");
  function Gg(A, g) {
    let I = A[nA];
    if (
      !I &&
      (Object.defineProperty(A, nA, { value: (I = new Proxy(A, ug)) }),
      !Array.isArray(A))
    ) {
  ...
  function Fg(A) {
    ...
    return (
      ...
      "object" == typeof A &&
      (A[nA] ||
        !(g = Object.getPrototypeOf(A)) ||
        g === Object.prototype ||
        Array.isArray(A))
    );
  }
  function qg(A, g = new Set()) {
    let I, B, Q, C;
    if ((I = null != A && A[lg])) return I;
    if (!Fg(A) || g.has(A)) return A;
    if (Array.isArray(A)) {
      Object.isFrozen(A) ? (A = A.slice(0)) : g.add(A);
      for (let I = 0, C = A.length; I < C; I++)
        ((Q = A[I]), (B = qg(Q, g)) !== Q && (A[I] = B));
    } else {
      ...
      for (let V = 0, e = I.length; V < e; V++)
        ((C = I[V]),
          E[C].get || ((Q = A[C]), (B = qg(Q, g)) !== Q && (A[C] = B)));
    }
    return A;
  }
  function dg(A) {
    let g = A[yg];
    return (g || Object.defineProperty(A, yg, { value: (g = {}) }), g);
  }
  function Mg(A, g, I) {
    return A[g] || (A[g] = fg(I));
  }
  ...
  function fg(A) {
    const [g, I] = MA(A, { equals: !1, internal: !0 });
    return ((g.$ = I), g);
  }
  const ug = {
    get(A, g, I) {
      if (g === lg) return A;
      if (g === nA) return I;
      if (g === rA) return (Ng(A), I);
      const B = dg(A),
        Q = B.hasOwnProperty(g);
      let C = Q ? B[g]() : A[g];
      if (g === yg || "__proto__" === g) return C;
      if (!Q) {
        const I = Object.getOwnPropertyDescriptor(A, g);
        !YA() ||
          ("function" == typeof C && !A.hasOwnProperty(g)) ||
          (I && I.get) ||
          (C = Mg(B, g, C)());
      }
      return Fg(C) ? Gg(C) : C;
    ...
    deleteProperty: () => !0,
    ownKeys: function (A) {
      return (Ng(A), Reflect.ownKeys(A));
    },
    getOwnPropertyDescriptor: function (A, g) {
      const I = Reflect.getOwnPropertyDescriptor(A, g);
      return I && !I.get && I.configurable && g !== nA && g !== yg && g !== kg
        ? (delete I.value, delete I.writable, (I.get = () => A[nA][g]), I)
        : I;
    },
  };
  function Rg(A, g, I, B = !1) {
    if (!B && A[g] === I) return;
    const Q = A[g],
      C = A.length;
  ...
  function Sg(A, g, I = []) {
    ...
    if (g.length > 1) {
      ...
      const C = typeof B,
        E = Array.isArray(A);
      if (Array.isArray(B)) {
        for (let Q = 0; Q < B.length; Q++) Sg(A, [B[Q]].concat(g), I);
        return;
      }
      if (E && "function" === C) {
        for (let Q = 0; Q < A.length; Q++)
          B(A[Q], Q) && Sg(A, [Q].concat(g), I);
        return;
      }
      if (E && "object" === C) {
        const { from: Q = 0, to: C = A.length - 1, by: E = 1 } = B;
        for (let B = Q; B <= C; B += E) Sg(A, [B].concat(g), I);
        return;
      }
      if (g.length > 1) return void Sg(A[B], g, [B].concat(I));
      ((Q = A[B]), (I = [B].concat(I)));
    }
    let C = g[0];
    ("function" == typeof C && ((C = C(Q, I)), C === Q)) ||
      (void 0 === B && null == C) ||
      ((C = qg(C)),
      void 0 === B || (Fg(Q) && Fg(C) && !Array.isArray(C))
        ? Jg(Q, C)
        : Rg(A, B, C));
  }
  function Yg(...[A, g]) {
  ...
  const Ug = Symbol("store-root");
  function pg(A, g, I, B, Q) {
    const C = g[I];
    if (A === C) return;
    if (!Fg(A) || !Fg(C) || (Q && A[Q] !== C[Q])) {
      if (A !== C) {
        if (I === Ug) return A;
        Rg(g, I, A);
      }
    ...
    if (Array.isArray(A)) {
      if (A.length && C.length && (!B || (Q && A[0] && null != A[0][Q]))) {
        let g, I, E, V, e, i, t, o;
        for (
          E = 0, V = Math.min(C.length, A.length);
          E < V &&
          (C[E] === A[E] || (Q && C[E] && A[E] && C[E][Q] === A[E][Q]));
          E++
        )
          pg(A[E], C, E, B, Q);
        const s = new Array(A.length),
          n = new Map();
        for (
          V = C.length - 1, e = A.length - 1;
          V >= E &&
          e >= E &&
          (C[V] === A[e] || (Q && C[E] && A[E] && C[V][Q] === A[e][Q]));
          V--, e--
        )
          s[e] = C[V];
        if (E > e || E > V) {
          for (I = E; I <= e; I++) Rg(C, I, A[I]);
          for (; I < A.length; I++) (Rg(C, I, s[I]), pg(A[I], C, I, B, Q));
          return void (C.length > A.length && Rg(C, "length", A.length));
        }
        for (t = new Array(e + 1), I = e; I >= E; I--)
          ((i = A[I]),
            (o = Q && i ? i[Q] : i),
            (g = n.get(o)),
            (t[I] = void 0 === g ? -1 : g),
        ...
        for (g = E; g <= V; g++)
          ((i = C[g]),
            ...
            void 0 !== I &&
              -1 !== I &&
              ((s[I] = C[g]), (I = t[I]), n.set(o, I)));
        for (I = E; I < A.length; I++)
          I in s ? (Rg(C, I, s[I]), pg(A[I], C, I, B, Q)) : Rg(C, I, A[I]);
      } else for (let g = 0, I = A.length; g < I; g++) pg(A[g], C, g, B, Q);
      return void (C.length > A.length && Rg(C, "length", A.length));
    }
    const E = Object.keys(A);
    for (let g = 0, I = E.length; g < I; g++) pg(A[E[g]], C, E[g], B, Q);
    const V = Object.keys(C);
    for (let g = 0, I = V.length; g < I; g++)
      void 0 === A[V[g]] && Rg(C, V[g], void 0);
  }
  function Lg(A, g = {}) {
    const { merge: I, key: B = "id" } = g,
      Q = qg(A);
    return (A) => {
      if (!Fg(A) || !Fg(Q)) return Q;
      const g = pg(Q, { [Ug]: A }, Ug, I, B);
      return void 0 === g ? A : g;
    };
  }
  const mg = eg("<span></span>");
  var Kg = (A) => {
    const g = fA(() => {
        if (1 == A.text.length) {
          const g = A.text.codePointAt(0);
          if ((g >= 9600 && g <= 9631) || 57520 == g || 57522 == g) return g;
        }
      }),
      I = fA(() => (g() ? " " : A.text)),
      B = fA(() =>
        (function (A, g, I) {
          const B = A.get("fg"),
            Q = A.get("bg");
          let C = { "--offset": g, width: `${I + 0.01}ch` };
          "string" == typeof B && (C["--fg"] = B);
          "string" == typeof Q && (C["--bg"] = Q);
          return C;
        })(A.pen, A.offset, A.width),
      ),
      Q = fA(() =>
        (function (A, g, I) {
          const B = bg(A.get("fg"), A.get("bold"), "fg-"),
            Q = bg(A.get("bg"), !1, "bg-");
          let C = I ?? "";
  ...
  function bg(A, g, I) {
    if ("number" == typeof A) return (g && A < 8 && (A += 8), `${I}${A}`);
  }
  const Hg = eg('<span class="ap-line" role="paragraph"></span>');
  var vg = (A) =>
    (() => {
      const g = Hg.cloneNode(!0);
      return (
        rg(
          g,
          PA(Ig, {
              ...
              return (() => {
                if ("number" == typeof A.cursor) {
                  ...
                  for (
                    ...
                    (g.push(Q), (I += Q.text.length), B++);
                  }
                  if (B < A.segments.length) {
                    const Q = A.segments[B],
                      C = A.cursor - I;
                    for (
                      C > 0 && g.push({ ...Q, text: Q.text.substring(0, C) }),
                        g.push({
                          ...Q,
                          text: Q.text[C],
                          offset: Q.offset + C,
              ...
              PA(
                ...
                (function (...A) {
                  ...
                  for (let I = 0; I < A.length; I++) {
                    const B = A[I];
                    ((g = g || (!!B && nA in B)),
                      (A[I] = "function" == typeof B ? ((g = !0), fA(B)) : B));
                  }
                  if (g)
                    return new Proxy(
                      {
                        ...
                        has(g) {
                          for (let I = A.length - 1; I >= 0; I--)
                            if (g in Ag(A[I])) return !0;
                          return !1;
                        },
                        keys() {
                          const g = [];
                          for (let I = 0; I < A.length; I++)
                            g.push(...Object.keys(Ag(A[I])));
                          return [...new Set(g)];
                        },
                      },
                      $A,
  ...
  const Tg = eg(
    '<pre class="ap-terminal" aria-live="polite" tabindex="0"></pre>',
  );
  var Og = (A) => {
    ...
    return (() => {
      const g = Tg.cloneNode(!0),
        C = A.ref;
      return (
        "function" == typeof C ? ng(C, g) : (A.ref = g),
        rg(
          g,
          PA(gg, {
            get each() {
        ...
        NA(
          (B) => {
            const Q = !(!A.blink && !A.cursorHold),
              ...
              E = I();
            return (
              Q !== B._v$ && g.classList.toggle("ap-cursor-on", (B._v$ = Q)),
              C !== B._v$2 && g.classList.toggle("ap-blink", (B._v$2 = C)),
              (B._v$3 = sg(g, E, B._v$3)),
              B
            );
          },
  ...
  const xg = eg(
    ...
    Zg = eg('<span class="ap-button ap-playback-button" tabindex="0"></span>'),
    Wg = eg(
  ...
  var $g = (A) => {
    const g = (A) => (g) => {
      ...
      I = () =>
        "number" == typeof A.currentTime ? Pg(A.currentTime) : "--:--",
      B = () =>
        "number" == typeof A.remainingTime ? "-" + Pg(A.remainingTime) : I(),
      Q = fA(() =>
        "number" == typeof A.duration
          ? A.markers.filter((g) => g[0] < A.duration)
          : [],
      ),
      C = (A) => {
      ...
      i = (g) => {
        g._marker ||
          ...
          g.ctrlKey ||
          0 !== g.button ||
          (V(!0), A.onSeekClick(C(g)));
      },
      t = (A) => {
        A.altKey || A.shiftKey || A.metaKey || A.ctrlKey || (E() && e(C(A)));
      },
      o = () => {
        V(!1);
      };
    return (
      ...
      (() => {
        const C = Xg.cloneNode(!0),
          ...
          r = A.ref;
        return (
          "function" == typeof r ? ng(r, C) : (A.ref = C),
          rg(
            C,
            PA(Bg, {
              get when() {
              ...
              get children() {
                const I = Zg.cloneNode(!0);
                return (
                  og(I, "click", g(A.onPlayClick), !0),
                  rg(
                    I,
                    PA(Qg, {
                      get children() {
            ...
            PA(Bg, {
              ...
              get children() {
                ...
                return (
                        ...
                        (() => {
                          ...
                          return (
                            ...
                            NA(
                              (g) => {
                                const B = ((g) =>
                                    (g[0] / A.duration) * 100 + "%")(I),
                                  E = !!((g) =>
                                    "number" == typeof A.currentTime &&
                                    g[0] <= A.currentTime)(I);
                                return (
                                  B !== g._v$ &&
                                    Q.style.setProperty("left", (g._v$ = B)),
                                  E !== g._v$2 &&
                                    C.classList.toggle(
                                      "ap-marker-past",
                                      (g._v$2 = E),
                  ...
                  NA((g) =>
                    sg(B, { transform: `scaleX(${A.progress || 0}` }, g),
                  ),
                  I
                );
              },
          ...
          og(s, "click", g(A.onHelpClick), !0),
          og(n, "click", g(A.onFullscreenClick), !0),
          NA(() => C.classList.toggle("ap-seekable", !!A.isSeekable)),
          C
        );
      })()
    );
  };
  ig(["click", "mousedown", "mousemove"]);
  const AI = eg(
    '<div class="ap-overlay ap-overlay-error"><span>💥</span></div>',
  );
  var gI = (A) => AI.cloneNode(!0);
  const II = eg(
    '<div class="ap-overlay ap-overlay-loading"><span class="ap-loader"></span></div>',
  );
  var BI = (A) => II.cloneNode(!0);
  const QI = eg('<div class="ap-overlay ap-overlay-info"><span></span></div>');
  var CI = (A) =>
    (() => {
      const g = QI.cloneNode(!0),
        I = g.firstChild;
      return (
        rg(I, () => A.message),
        NA((g) => sg(I, { "font-family": A.fontFamily }, g)),
        g
      );
    })();
  const EI = eg(
  ...
  var iI = (A) =>
    (() => {
      ...
      return (
        ...
        NA((I) => sg(g, { "font-family": A.fontFamily }, I)),
        g
      );
    })();
  ig(["click"]);
  const tI = eg('<div class="ap-wrapper" tabindex="-1"><div></div></div>');
  var oI = (A) => {
    const g = A.logger,
      I = A.core,
      B = A.autoPlay,
      ...
      [s, n] = MA(
        ...
        { equals: (A, g) => A.cols === g.cols && A.rows === g.rows },
      ),
      [r, a] = MA(void 0),
      [c, D] = Yg([]),
      [w, h] = MA(!1),
      ...
      q = fA(() => s().rows || 24),
      d = () => (!1 === A.controls ? 0 : 32);
    let M, N, f, u, R, J, S, Y, U;
    function p() {
      ($(), z(), P());
    }
    function L(A) {
      uA(() => {
        (A.rows < s().rows && C("lines", Q.lines.slice(0, A.rows)), n(A));
      });
    }
    function m(A) {
    ...
    (I.addEventListener("init", (A) => {
      ...
      uA(() => {
        (L({ cols: g, rows: I }), a(B), G(Q), D(E), m(C));
      });
    }),
      ...
      I.addEventListener("offline", (A) => {
        let { message: g } = A;
        uA(() => {
          (V(!1), p(), void 0 !== g && (o(g), i("info")));
        });
      }));
    let K = 0;
    (I.addEventListener("ended", (A) => {
      let { message: I } = A;
      (uA(() => {
        (V(!1), p(), void 0 !== I && (o(I), i("info")));
      }),
        g.debug(`view: render count: ${K}`));
    }),
      ...
      I.addEventListener("reset", (A) => {
        let { cols: g, rows: I, theme: B } = A;
        uA(() => {
          (L({ cols: g, rows: I }), G(B), H());
        });
      }),
      ...
      I.addEventListener("terminalUpdate", () => {
        void 0 === M && (M = requestAnimationFrame(H));
      }));
    const b = () => {
      ((U = new ResizeObserver(
        (function (A, g) {
          ...
          (C({ containerW: R.offsetWidth, containerH: R.offsetHeight }),
            R.dispatchEvent(new CustomEvent("resize", { detail: { el: J } })));
        }, 10),
      )),
        U.observe(R));
    };
    (JA(async () => {
      (g.info("view: mounted"),
        g.debug("view: font measurements", { charW: Q.charW, charH: Q.charH }),
        b());
      const { isPausable: A, isSeekable: E, poster: V } = await I.init();
      (uA(() => {
        (C({
          isPausable: A,
          isSeekable: E,
          containerW: R.offsetWidth,
          containerH: R.offsetHeight,
        }),
          m(V));
      }),
        B && I.play());
      ...
      SA(() => {
        (I.stop(), $(), z(), U.disconnect());
      }));
    const H = async () => {
        const A = await I.getChanges();
        (uA(() => {
          (void 0 !== A.lines &&
            A.lines.forEach((A, g) => {
              C("lines", g, Lg(A));
            }),
            void 0 !== A.cursor && C("cursor", Lg(A.cursor)),
            C("cursorHold", !0));
        }),
          (M = void 0),
          (K += 1));
      ...
      v = fA(() => {
        const g = Q.charW * F() + Q.bordersW,
          I = Q.charH * q() + Q.bordersH;
        let B = A.fit ?? "width";
        if ("both" === B || Q.isFullscreen) {
          B = Q.containerW / (Q.containerH - d()) > g / I ? "height" : "width";
        }
        if (!1 === B || "none" === B) return {};
        if ("width" === B) {
          const A = Q.containerW / g;
          return { scale: A, width: Q.containerW, height: I * A + d() };
        }
        if ("height" === B) {
          const A = (Q.containerH - d()) / I;
          return { scale: A, width: g * A, height: Q.containerH };
        }
        throw `unsupported fit mode: ${B}`;
      }),
      T = () => {
        C(
          "isFullscreen",
      ...
      j = (A) => {
        if (!(A.altKey || A.metaKey || A.ctrlKey)) {
          ...
          else if ("," == A.key) (I.step(-1), P());
          else if ("." == A.key) (I.step(), P());
          else if ("f" == A.key) O();
      ...
      P = async () => {
        const A = await I.getCurrentTime(),
          g = await I.getRemainingTime(),
          B = await I.getProgress();
      ...
      $ = () => {
        (clearInterval(u), C("blink", !0));
      },
      AA = (A) => {
        (clearTimeout(N), A && (N = setTimeout(() => AA(!1), 2e3)), h(A));
      },
      gA = fA(() => {
        const g = A.theme || "auto/asciinema";
        return "auto/" === g.slice(0, 5)
          ? { name: g.slice(5), colors: k() }
          : { name: g };
      }),
      IA = (() => {
        const g = tI.cloneNode(!0),
          B = g.firstChild;
        ("function" == typeof R ? ng(R, g) : (R = g),
          g.addEventListener("webkitfullscreenchange", T),
          g.addEventListener("fullscreenchange", T),
          (g.$$mousemove = Z),
          (g.$$keydown = j));
        return (
          "function" == typeof J ? ng(J, B) : (J = B),
          (B.$$mousemove = () => AA(!0)),
          ...
          NA(
            (I) => {
              const Q = !!(!0 === A.controls || ("auto" === A.controls && w())),
                C = `ap-player asciinema-player-theme-${gA().name}`,
                E = (() => {
                  const g = {};
                  (!1 !== A.fit && "none" !== A.fit) ||
                  ...
                  return (
                    void 0 !== B &&
                      ((g["--term-color-foreground"] = B.foreground),
                      (g["--term-color-background"] = B.background),
                      B.palette.forEach((A, I) => {
                        g[`--term-color-${I}`] = A;
                      })),
                    g
                  );
              ...
              return (
                ...
                C !== I._v$2 && tg(B, (I._v$2 = C)),
                (I._v$3 = sg(B, E, I._v$3)),
                I
              );
            },
            { _v$: void 0, _v$2: void 0, _v$3: void 0 },
  ...
  function sI(A, g) {
    ...
    const B = (function (A, g) {
        ...
        return (E(), document.body.removeChild(Q), V);
    ...
    const E = Vg(() => ((C = PA(oI, Q)), C), g),
      V = {
        ...
        pause: () => A.pause(),
        seek: (g) => A.seek(g),
        addEventListener: (g, I) => A.addEventListener(g, I.bind(V)),
      };
    return V;
  }
  ig(["keydown", "mousemove"]);
  const nI = [
      "cols",
      "idleTimeLimit",
      "loop",
